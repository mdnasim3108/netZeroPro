       ...
       <table className="border-collapse h-[100px]  mb-5">
        ...
        <div className=" flex justify-between">
          <table className="border-collapse h-[100px]  mb-5 w-[100%]">
            ...
            <tr className="">
                  ...
                  <th className="border-violet-700 border-2">
                  Indicate Whether holding / subsidiary / associate companies / joint ventures
                  </th>
                  <th className="border-violet-700 border-2">
                    % of shares held by listed entity
                  </th>
                  <th className="border-violet-700 border-2">
                    Does the entity indicated at column A,participate in the responsibility initiatives of the listed entity ? (Yes/No)
                  </th>
                </tr>
            </thead>
        ...
        <div className="flex justify-end">
          ...
          <div className="flex justify-between">
            ...
            <h1 className="text-center mb-5 font-bold text-lg">Transparency and Disclosures Compliances:</h1>
            <h1 className="text-center mb-5 font-bold text-lg">Overview of the entity’s material responsible business conduct issues:</h1>
